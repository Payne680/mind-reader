...
chats.forEach(c => {
  ...
  users.forEach((u: { name: string; avatar: any; }) => {
    if (u.name !== c.name) {
  ...
  return (
    <div className="h-10  overflow-hidden">
      <div className="row no-gutters">
        <Container fluid className="p-1 position-relative overflow-hidden bg-black">
          <Row className="h-1 m-2 pb-1 flex-nowrap">
            <Col>
              <ChatProvider
                serviceFactory={serviceFactory} storage={akaneStorage} config={{
